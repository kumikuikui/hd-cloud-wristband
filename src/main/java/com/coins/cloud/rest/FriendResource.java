...
import com.coins.cloud.vo.DeleteFriendVo;
...
public class FriendResource {
	...
	public BoUtil searchUser(@QueryParam("account") String account, @QueryParam("userId") Integer userId)
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/dismiss", method = RequestMethod.POST, produces = "application/json", consumes = "application/json")
	public BoUtil dismissFriend(final @RequestBody DeleteFriendVo deleteFriendVo) {
		log.info(" deleteFriendVo : {} ", deleteFriendVo);
		BoUtil boUtil = BoUtil.getDefaultTrueBo();
		int userId = deleteFriendVo.getUserId();
		int targetUserId = deleteFriendVo.getTargetUserId();
